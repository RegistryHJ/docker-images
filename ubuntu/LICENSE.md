# Creative Commons CC-BY-SA v3.0 UK

This repository includes Dockerfiles based on the Docker Official Images, which are licensed under the Creative Commons Attribution-ShareAlike 3.0 UK License.
...
This repository contains modified versions of the original Ubuntu Docker Official Images.
...
- Licensed under CC BY-SA 3.0 UK (Same as Original)
- Source: https://github.com/RegistryHJ/docker-images/tree/master/ubuntu
...
Copyright © 2025 RegistryHJ (Modifications only)
